...
// Printing Results
//
    out=fopen("Result_Application_1.txt","a+"); // Opening output file of results
    if(!out){
    ...
    fprintf(out,"%6d %6d %6d %6d %6d",cnt_word, cnt_uniq_word, cnt_palind, cnt_char, cnt_line);
